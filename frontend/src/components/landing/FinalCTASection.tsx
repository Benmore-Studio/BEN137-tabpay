  ...
  return (
    <section className="py-24 lg:py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6">
        <motion.div
          className="bg-white rounded-3xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] ring-1 ring-slate-900/5 overflow-hidden"
          ...
          <div className="p-8 sm:p-12 lg:p-16 text-center">
            ...
            <div className="mb-6">
              <Link to={isAuthenticated ? "/menu" : "/auth"}>
                <motion.button
                  className="inline-flex items-center justify-center gap-2 px-12 h-14 text-lg font-semibold rounded-xl bg-gradient-to-r from-primary-600 to-primary-700 text-white shadow-xl shadow-primary-500/30 hover:shadow-primary-500/40 hover:from-primary-700 hover:to-primary-800"
