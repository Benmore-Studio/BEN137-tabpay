    ...
    <section className="py-16 sm:py-24 lg:py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-10 gap-6">
          ...
          <div className="lg:col-span-7 lg:row-span-2 group relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-12 shadow-[0_4px_20px_-5px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-500 overflow-hidden border-t-[6px] border-primary-500">
            <div className="relative h-full flex flex-col justify-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center mb-6 sm:mb-8 shadow-xl shadow-primary-500/20 group-hover:scale-110 transition-transform duration-500">
          ...
          <div className="lg:col-span-10 group relative bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4),inset_0_1px_0_0_rgba(255,255,255,0.05)] hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] hover:-translate-y-1 transition-all duration-500 overflow-hidden">
            ...
            <div className="relative flex flex-col lg:flex-row lg:items-center gap-6 sm:gap-8">
              <div className="flex-1">
                <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-gold-400 to-gold-600 flex items-center justify-center mb-4 sm:mb-6 shadow-xl shadow-gold-500/30 group-hover:scale-110 transition-transform duration-500">
