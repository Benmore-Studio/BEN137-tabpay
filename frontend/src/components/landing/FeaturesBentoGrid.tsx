    ...
    <section className="py-24 lg:py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-10 gap-6">
          ...
          <div className="lg:col-span-7 lg:row-span-2 group relative bg-white rounded-3xl p-10 lg:p-12 shadow-[0_4px_20px_-5px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-500 overflow-hidden border-t-[6px] border-primary-500">
            <div className="relative h-full flex flex-col justify-center">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center mb-8 shadow-xl shadow-primary-500/20 group-hover:scale-110 transition-transform duration-500">
                <Clock className="w-10 h-10 text-white" />
              </div>
              <h3 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-6">Never leave your lucky seat</h3>
              <p className="text-slate-600 text-xl leading-[1.6] mb-8 max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-3 px-6 py-4 rounded-2xl bg-primary-50 border-2 border-primary-100 shadow-lg">
                  <span className="text-4xl font-bold text-primary-600">~8</span>
                  <span className="text-sm text-primary-700 font-medium">min delivery</span>
                </div>
                <div className="flex items-center gap-3 px-6 py-4 rounded-2xl bg-slate-100 border-2 border-slate-200 shadow-lg">
                  <span className="text-4xl font-bold text-slate-700">0</span>
                  <span className="text-sm text-slate-600 font-medium">hands missed</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            {/* GPS delivery */}
            <div className="group relative bg-white rounded-3xl p-6 shadow-[0_4px_20px_-5px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-500 border-t-[6px] border-gold-500">
              <div className="relative">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-gold-400 to-gold-600 flex items-center justify-center mb-4 shadow-lg shadow-gold-500/20 group-hover:scale-110 transition-transform duration-500">
            ...
            {/* Secure payments */}
            <div className="group relative bg-white rounded-3xl p-6 shadow-[0_4px_20px_-5px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-500 border-t-[6px] border-green-500">
              <div className="relative">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-500 to-green-700 flex items-center justify-center mb-4 shadow-lg shadow-green-500/20 group-hover:scale-110 transition-transform duration-500">
