          ...
          <div className="lg:col-span-10 group relative bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4),inset_0_1px_0_0_rgba(255,255,255,0.05)] overflow-hidden">
            ...
            <div className="relative flex flex-col lg:flex-row lg:items-center gap-6 sm:gap-8">
              <div className="flex-1">
                <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-gold-400 to-gold-600 flex items-center justify-center mb-4 sm:mb-6 shadow-xl shadow-gold-500/30">
